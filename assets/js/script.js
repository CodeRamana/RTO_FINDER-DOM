...
console.log(typeof(htmlData)) //String
...
const tbody =data.getElementsByTagName('tbody')

const trArr =[...tbody[0].children]

let RTOData =[]
let id=1;
trArr.forEach((record)=>{
...
downloadFile(RTOData,"data.json",'application/json')